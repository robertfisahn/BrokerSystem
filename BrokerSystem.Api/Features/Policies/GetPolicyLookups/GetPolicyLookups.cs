...
/// <summary>
/// Query to retrieve lookup data for policy creation, including active clients, policy types, and agents.
/// </summary>
...
public class GetPolicyLookupsHandler(BrokerSystemDbContext db)
    : IRequestHandler<GetPolicyLookupsQuery, PolicyLookupsResponse>
{
...
public static class LookupMapper
{
    ...
    public static LookupDto MapAgent(dynamic a)
    {
        ...
        string name = !string.IsNullOrWhiteSpace(firstName + lastName)
